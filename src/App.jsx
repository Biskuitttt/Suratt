...
const FilmRoll = () => {
  const photos = Array.from({ length: 15 }, (_, index) => ({
    ...
    // nanti lu tambahinnya kayak gini pete buat photonya null nya di akhir arraynya cuman 15 nanti kalau lu mau adjust tambahin sendiri atau bilang aja
  }));
      ...
      <div className="relative z-10 min-h-screen">
        <div className="container mx-auto px-4 py-16">
          <div className="text-center mb-16">
            <h1 className="text-6xl font-bold text-stone-800 mb-4">OMB kontol</h1>
            <p className="text-xl text-stone-600">Untung gw gak panit</p>
          </div>
